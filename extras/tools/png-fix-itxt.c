 ...
 *
 * If you need to handle iTXt chunks larger than 500000 bytes you must
  ...
  if (inchar == c) /* !EOF */
    for (;;)
    {
      ...
      if (buf[4] == 105 && buf[5] == 84 && buf[6] == 88 && buf[7] == 116)
      {
        ...
        {
          /* Check the CRC */
          if (((crc >> 24) & 0xffU) == buf[length + 8] && ((crc >> 16) & 0xffU) == buf[length + 9]
              && ((crc >> 8) & 0xffU) == buf[length + 10] && ((crc) & 0xffU) == buf[length + 11])
            break;
