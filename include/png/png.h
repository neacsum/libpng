...
typedef PNG_CALLBACK(void, *png_read_ptr, (png_struct*, png_bytep, size_t));
typedef PNG_CALLBACK(void, *png_write_ptr, (png_struct*, png_const_bytep, size_t));
...
typedef void (PNGCBAPI *png_user_transform_ptr) (png_struct*, png_row_infop,
    png_bytep);

typedef int (PNGCBAPI *png_user_chunk_ptr) (png_struct*,png_unknown_chunkp);
 ...
 * following.
 */
typedef PNG_CALLBACK(png_voidp, *png_malloc_ptr, (const png_struct*,
    size_t));
typedef PNG_CALLBACK(void, *png_free_ptr, (const png_struct*, png_voidp));
...
png_struct* PNGAPI
png_create_read_struct (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn,
  png_error_ptr warn_fn);

/* Allocate and initialize png_ptr struct for writing, and any other memory */
png_struct* PNGAPI
png_create_write_struct (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn,
  png_error_ptr warn_fn);
 ...
 */
jmp_buf* PNGAPI
png_set_longjmp_fn (png_structrp png_ptr, png_longjmp_ptr longjmp_fn, size_t jmp_buf_size);
...
png_create_read_struct_2 (png_const_charp user_png_ver, png_voidp error_ptr, 
  png_error_ptr error_fn, png_error_ptr warn_fn, png_voidp mem_ptr, png_malloc_ptr malloc_fn, png_free_ptr free_fn);

png_struct* PNGAPI
png_create_write_struct_2 (png_const_charp user_png_ver, png_voidp error_ptr, png_error_ptr error_fn,
...
void PNGAPI 
png_set_rgb_to_gray_fixed (png_structrp png_ptr, int error_action, png_fixed_point red,
...
void PNGAPI
png_set_gamma_fixed (png_structrp png_ptr, png_fixed_point screen_gamma, 
...
void PNGAPI 
png_set_compression_mem_level (png_structrp png_ptr,
 int mem_level);

void PNGAPI 
png_set_compression_strategy (png_structrp png_ptr,
    int strategy);
 ...
 */
void PNGAPI
png_set_write_fn (png_structrp png_ptr, png_voidp io_ptr, png_write_ptr write_data_fn, png_flush_ptr output_flush_fn);

/* Replace the default data input function with a user supplied one. */
void PNGAPI
png_set_read_fn (png_structrp png_ptr, png_voidp io_ptr, png_read_ptr read_data_fn);
...
void PNGAPI 
png_set_user_transform_info (png_structrp png_ptr, png_voidp user_transform_ptr, int user_transform_depth,
 ...
 */
png_uint_32 PNGAPI
png_get_current_row_number (png_const_structrp);

png_byte PNGAPI
png_get_current_pass_number (png_const_structrp);
 ...
 */
size_t PNGAPI
png_process_data_pause (png_structrp, int save);
...
void PNGAPI 
png_benign_error (png_const_structrp png_ptr, png_const_charp warning_message);

/* Same, chunk name is prepended to message (only during read) */
void PNGAPI
png_chunk_benign_error (png_const_structrp png_ptr, png_const_charp warning_message);
...
png_uint_32 PNGAPI
png_get_cHRM (png_const_structrp png_ptr, png_const_inforp info_ptr, double *white_x, 
  double *white_y, double *red_x, double *red_y, double *green_x, double *green_y, double *blue_x,
  double *blue_y);

png_uint_32 PNGAPI 
png_get_cHRM_XYZ (png_const_structrp png_ptr, png_const_inforp info_ptr, double *red_X, 
  double *red_Y, double *red_Z, double *green_X, double *green_Y, double *green_Z, double *blue_X,
  double *blue_Y, double *blue_Z);

png_uint_32 PNGAPI
png_get_cHRM_fixed (png_const_structrp png_ptr, png_const_inforp info_ptr, png_fixed_point *int_white_x, 
...
png_uint_32 PNGAPI 
png_get_cHRM_XYZ_fixed (png_const_structrp png_ptr, png_const_inforp info_ptr, png_fixed_point *int_red_X,
...
void PNGAPI
png_set_cHRM (png_const_structrp png_ptr, png_inforp info_ptr, double white_x, double white_y, 
  double red_x, double red_y, double green_x, double green_y, double blue_x, double blue_y);

void PNGAPI 
png_set_cHRM_XYZ (png_const_structrp png_ptr, png_inforp info_ptr, double red_X, double red_Y, 
  double red_Z, double green_X, double green_Y, double green_Z, double blue_X, double blue_Y, 
  double blue_Z);

void PNGAPI 
png_set_cHRM_fixed (png_const_structrp png_ptr, png_inforp info_ptr, png_fixed_point int_white_x,
   png_fixed_point int_white_y, png_fixed_point int_red_x, png_fixed_point int_red_y,
   png_fixed_point int_green_x, png_fixed_point int_green_y, png_fixed_point int_blue_x,
   png_fixed_point int_blue_y);

void PNGAPI
png_set_cHRM_XYZ_fixed (png_const_structrp png_ptr, png_inforp info_ptr, png_fixed_point int_red_X,
   png_fixed_point int_red_Y, png_fixed_point int_red_Z, png_fixed_point int_green_X,
   png_fixed_point int_green_Y, png_fixed_point int_green_Z, png_fixed_point int_blue_X,
   png_fixed_point int_blue_Y, png_fixed_point int_blue_Z);
...
png_set_IHDR (png_const_structrp png_ptr, png_inforp info_ptr, png_uint_32 width, 
  png_uint_32 height, int bit_depth, int color_type, int interlace_method, int compression_method,
  int filter_method);
...
void PNGAPI 
png_set_pCAL (png_const_structrp png_ptr, png_inforp info_ptr, png_const_charp purpose, 
  png_int_32 X0, png_int_32 X1, int type, int nparams, png_const_charp units, png_charpp params);

png_uint_32 PNGAPI
png_get_pHYs (png_const_structrp png_ptr, png_const_inforp info_ptr, png_uint_32 *res_x, 
...
png_uint_32 PNGAPI
png_get_PLTE (png_const_structrp png_ptr, png_inforp info_ptr, png_colorp *palette, 
  int *num_palette);
...
png_uint_32 PNGAPI 
png_get_iCCP (png_const_structrp png_ptr, png_inforp info_ptr, png_charpp name, 
  int *compression_type, png_bytepp profile, png_uint_32 *proflen);

void PNGAPI 
png_set_iCCP (png_const_structrp png_ptr, png_inforp info_ptr, png_const_charp name, 
...
png_uint_32 PNGAPI 
png_get_tRNS (png_const_structrp png_ptr, png_inforp info_ptr, png_bytep *trans_alpha, 
...
#endif
png_uint_32 PNGAPI 
png_get_sCAL_s (png_const_structrp png_ptr, png_const_inforp info_ptr, int *unit, png_charpp swidth, 
  png_charpp sheight);

void PNGAPI 
png_set_sCAL (png_const_structrp png_ptr, png_inforp info_ptr, int unit, double width, 
  double height);
void PNGAPI 
...
void PNGAPI 
png_set_sCAL_s (png_const_structrp png_ptr, png_inforp info_ptr, int unit, png_const_charp swidth,
...
void PNGAPI
png_set_chunk_malloc_max (png_structrp png_ptr, size_t user_chunk_cache_max);
 ...
 */
int PNGAPI 
png_image_write_to_file (png_imagep image, const char *file, 
  int convert_to_8bit, const void *buffer, png_int_32 row_stride, 
  const void *colormap);
   /* Write the image to the named file. */

int PNGAPI 
png_image_write_to_stdio (png_imagep image, FILE *file,
